  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans antialiased selection:bg-blue-900 selection:text-white">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8">
        ...
        <section className="space-y-4" id="intro-section" ref={formSectionRef}>
          ...
          <div className="flex items-center space-x-2 text-xs font-semibold text-blue-900 uppercase tracking-wider">
            ...
            <span className="text-slate-600 font-normal">Civic Problem Registry</span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2 pt-1 text-xs text-slate-600">
            <span className="font-semibold text-slate-800">{t('connectedPartners')}:</span>
            <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-white border border-slate-200 rounded-md shadow-2xs font-medium text-slate-700">
              <Building2 className="w-3.5 h-3.5 text-blue-900" /> {t('partnerGov')}
            </span>
            <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-white border border-slate-200 rounded-md shadow-2xs font-medium text-slate-700">
              <GraduationCap className="w-3.5 h-3.5 text-orange-600" /> {t('partnerUnis')}
            </span>
            <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-white border border-slate-200 rounded-md shadow-2xs font-medium text-slate-700">
              <Users2 className="w-3.5 h-3.5 text-emerald-700" /> {t('partnerNgos')}
            </span>
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8">
            {submittedData ? (
              <SubmissionSuccess payload={submittedData} onReset={handleReset} />
            ) : (
